...
namespace Coreplus.Sample.Api.Services.Dtos
{
    public class Dtos
    {
        ...
        public record PractitionersAppointmentByMonthDto(string date, int revenue, int cost);
        ...
        public record PractitionerAppointmentByMonthListDto(int totalCount, IEnumerable<PractitionersAppointmentByMonthDto> data);
